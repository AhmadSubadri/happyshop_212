...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg_1.jpg'); ?>');">
  ...
  <section class="ftco-section contact-section bg-light">
    <div class="container">
        ...
        <div class="col-md-3 d-flex">
            <div class="info bg-white p-4">
              <p><span>Website</span> www.happyshop212.com</p>
            </div>
        </div>
      </div>
        ...
        <div class="col-md-6 order-md-last d-flex">
          ...
          <?php endif; ?>
            ...
            <div class="form-group">
              <input type="text" name="name" class="form-control" value="<?php echo set_value('name', (is_login() ? get_admin_name() : '')); ?>" placeholder="Nama" required>
