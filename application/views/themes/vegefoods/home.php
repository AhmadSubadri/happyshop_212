			...
			<div class="container">
				<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
					...
					<div class="col-md-12 ftco-animate text-center">
						<h1 class="mb-2">Kami Menjual Berbagai kebutuhan Anda dengan harga terjangkau</h1>
						<h2 class="subheading mb-4">Sayur dan Buah Segar Langsung dari Kebun dan barang yang selalu baru</h2>
			...
			<div class="container">
				<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
					...
					<div class="col-sm-12 ftco-animate text-center">
						<h1 class="mb-2">Prabotan terbaik untuk ibu masak dirumah</h1>
						<h2 class="subheading mb-4">pilih kebutuhan anda yang berkualitas</h2>
						<p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
					</div>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg_2.jpg'); ?>);">
			...
			<div class="container">
				<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
					...
					<div class="col-sm-12 ftco-animate text-center">
						<h1 class="mb-2">100% Sayur, Buah, dan Prabotan yang selalu baru</h1>
						<h2 class="subheading mb-4">pilih kebutuhan anda yang berkualitas</h2>
						<p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
					</div>
			...
			<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
				<div class="media block-6 services mb-md-0 mb-4">
					...
					<div class="media-body">
						...
						<span>Barang langsung dari Distributor Terbaik</span>
					</div>
				</div>
			</div>
			<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
				<div class="media block-6 services mb-md-0 mb-4">
					...
					<div class="media-body">
						...
						<span>Kualitas dari Barang Terjamin</span>
					</div>
				</div>
			</div>
			<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
			...
			<div class="col-md-6 col-lg-3 ftco-animate">
				<div class="product text-center">
					<a href="<?php echo site_url('shop/product/'. $product->id .'/'. $product->sku .'/'); ?>" class="img-prod">
						<img class="img-fluid" src="<?php echo base_url('assets/uploads/products/'. $product->picture_name); ?>"
							alt="<?php echo $product->name; ?>" style="height: 200px;">
						<?php if ($product->current_discount > 0) : ?>
						<span class="status">Disc
							<?php echo count_percent_discount($product->current_discount, $product->price, 0); ?>%</span>
						<?php endif; ?>
						<div class="overlay"></div>
					</a>
					<div class="text py-3 pb-4 px-3 text-center">
						...
						<div class="d-flex">
							<div class="pricing">
								<p class="price">
									<?php if ($product->current_discount > 0) : ?>
									<span class="mr-2 price-dc">Rp <?php echo format_rupiah($product->price); ?></span><span
										class="price-sale">Rp
